...
The following function implemented in genieml_src can be used to derive fractionally differentiated features.

.. py:currentmodule:: Modules.features.fracdiff
...
The following function implemented in genieml_src can be used to achieve stationarity with maximum memory representation.
