...
.. py:currentmodule:: Modules.feature_importance.importance
.. automodule:: Modules.feature_importance.importance
   :members:
...
.. py:currentmodule:: Modules.feature_importance.fingerpint
.. autoclass:: Modules.feature_importance.fingerpint.AbstractModelFingerprint
   :members:

.. autoclass:: Modules.feature_importance.fingerpint.ClassificationModelFingerprint
   :members:

.. autoclass:: Modules.feature_importance.fingerpint.RegressionModelFingerprint
   :members:
...
.. py:currentmodule:: Modules.feature_importance.orthogonal
.. automodule:: Modules.feature_importance.orthogonal
   :members: get_orthogonal_features, get_pca_rank_weighted_kendall_tau, feature_pca_analysis

Example
*******

Let's see how PCA feature extraction is analysis are done using genieml_src functions:
