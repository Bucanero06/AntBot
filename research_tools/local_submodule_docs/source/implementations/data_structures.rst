...
format referred to as bars, where a bar represents a row in a table. genieml_src implements tick, volume, and dollar bars
...
.. py:currentmodule:: Modules.data_structures.time_data_structures
...
.. py:currentmodule:: Modules.data_structures.standard_data_structures
...
2 types of imbalance bars are implemented in genieml_src:
...
The logic described above is implemented in the **genieml_src** package under ImbalanceBars

Implementation
==============

.. py:currentmodule:: Modules.data_structures.imbalance_data_structures
...
2 types of run bars are implemented in genieml_src:
...
.. py:currentmodule:: Modules.data_structures.run_data_structures
...
it was more than 25 gigs. It is for this reason that the genieml_src package suggests using a file path to read the raw data
files from disk.
