...
class TradeAPI(Client):
    ...
    def place_order(self, instId, tdMode, side, ordType, sz, ccy='', clOrdId='', tag='', posSide='', px='',
        ...
        params = {'instId': instId, 'tdMode': tdMode, 'side': side, 'ordType': ordType, 'sz': sz, 'ccy': ccy,
                  ...
                  # This one is commented out because it needs multiple TP's to work and is not developed yet
                  # 'amendPxOnTriggerType': amendPxOnTriggerType
                  }
        # 'attachAlgoOrds': [
        #     {
        #         "attachAlgoClOrdId": f'{clOrdId}TP',
        #         "tpTriggerPx": str(float(tpTriggerPx) + 0.5),
        #         "tpOrdPx": '-1',
        #         'amendPxOnTriggerType': amendPxOnTriggerType,
        #     },
        #     {
        #         "attachAlgoClOrdId": f'{clOrdId}TP2',
        ...
        #     },
        #     {
        #         "attachAlgoClOrdId": f'{clOrdId}SL',
    ...
    def get_fills(self, instType='', uly='', instId='', ordId='',
                  after='', before='', limit='', instFamily='', begin='', end=''):
    ...
    def place_algo_order(self, instId='', tdMode='', side='', ordType='', sz='', ccy='',
                         ...
                         , quickMgnType='', algoClOrdId='', cxlOnClosePos=''):
        params = {'instId': instId, 'tdMode': tdMode, 'side': side, 'ordType': ordType, 'sz': sz, 'ccy': ccy,
