...
async def homepage(q: Q):
    ...
    add_card(q, 'Homepage_Header', ui.header_card(box='header', title='Home', subtitle='Welcome to the H2O Dashboard',
                                                  # Color
                                                  color='transparent',
                                                  icon='Home',
                                                  icon_color=None,
                                                  ))
    add_card(q, 'Homepage_Sidebar', ui.nav_card(
        box='sidebar',
        items=[
    ...
    add_card(q, 'Homepage_Content', ui.form_card(box='content', items=[
