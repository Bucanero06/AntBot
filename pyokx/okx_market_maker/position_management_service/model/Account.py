...
class AccountDetail:
    ...
    def to_dict(self):
        return {
            ...
            "eq": self.eq,
            "eq_usd": self.eq_usd,
            "frozen_bal": self.frozen_bal,
            "interest": self.interest,
            "iso_eq": self.iso_eq,
            "liability": self.liability,
            "max_loan": self.max_loan,
            "notional_lever": self.notional_lever,
            "ord_frozen": self.ord_frozen,
            "upl": self.upl,
            "upl_liability": self.upl_liability,
            "cross_liability": self.cross_liability,
            "iso_liability": self.iso_liability,
            "coin_usd_price": self.coin_usd_price,
            "strategy_eq": self.strategy_eq,
            "spot_in_usd_amt": self.spot_in_usd_amt,
            "iso_upl": self.iso_upl
        }
