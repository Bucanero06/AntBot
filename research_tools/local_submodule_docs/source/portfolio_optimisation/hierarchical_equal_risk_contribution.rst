...
.. note::
    ...
    better weights. The HERC method in genieml_src provides the following risk metrics:
...
.. tip::
    ...
    The following linkage methods are supported by the HERC class in Modules. (The following is taken directly from and we highly
    recommend you read):
...
* `How to use genieml_src's HierarchicalEqualRiskContribution class`_

.. _How to use genieml_src's HierarchicalEqualRiskContribution class: https://github.com/hudson-and-thames/research/blob/master/Portfolio%20Optimisation%20Tutorials/Hierarchical%20Equal%20Risk%20Contribution%20(HERC)/HERC%20Tutorial%20Notebook.ipynb